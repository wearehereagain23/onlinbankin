...
app.post('/register.html', async (req, res) => {
    ...
    var transporter = nodemailer.createTransport({
        ...
        service: 'SMTP',
        auth: {
            user: "onlinbankin@assistin.online",
            pass: "LineBankingOn20#"
        },
        from: "onlinbankin@assistin.online",
    });

    const mail_option = {
        from: `OnlinBankin <noreply@assistin.online>`,
        to: info.email,
        subject: "Welcome Message From OnlinBankin",
        html:
            `
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h3 style="color: greenyellow;">OnlinBankin</h3>
            <p>Your trusted partner in modern banking</p>
        </div>

        <div class="greeting">Hello, ${info.name}!</div>
        <div class="message">
            We’re delighted you're now part of the <strong>OnlinBankin</strong> family. Welcome aboard! Here, banking
        ...
        <div class="message">
            ...
            anytime or visit our <a href="https://onlinbankin.web.app">Support Center</a>.
        </div>

        <div class="footer">
            © 2025 OnlinBankin. All rights reserved.<br>
...
app.post('/login.html', async (req, res) => {
    ...
    const mail_option = {
        from: `OnlinBankin <noreply@assistin.online>`,
        to: info.email,
        subject: "New Message From OnlinBankin",
        html: `
...
<body>
    <div class="container">
        ...
        <div class="message">
            We received a request to log in to your <strong>OnlinBankin</strong> account.
        ...
        <div class="message">
            If you did not request this login, please <a href="https://onlinbankin.web.app/contact/index.html">contact
                support</a>
            immediately.
        </div>
...
<body>
    <div class="container">
        ...
        <div class="message">
            We received change password request to your <strong>OnlinBankin</strong> account.
            To continue, please enter the One-Time Password (OTP) below.
        </div>
...
<head>
    <meta charset="UTF-8">
    <title>Money Transfer Alert - OnlinBankin</title>
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <style>
        body {
            margin: 0;
    ...
    <div class="container">
        ...
        <div class="details">
            <table class="detail-table">
                ...
                <tr>
                    <th>Bank Name</th>
                    <td style="color: white;">OnlinBankin</td>
                </tr>
                <tr>
        ...
        <!-- Footer -->
        <div class="footer">
            This is an automated notification from <strong>OnlinBankin</strong>.
            If you did not authorize this transaction, please <a
                href="https://onlinbankin.web.app/contact/index.html">contact support immediately</a>.
            <br><br>© 2025 OnlinBankin. All rights reserved.
        </div>
    </div>
</body>
